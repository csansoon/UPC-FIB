...
input_pubkey = 'files/carlos.sanson_pubkeyRSA_RW.pem'
input_encrypted_key = 'files/carlos.sanson_RSA_RW.enc'
input_encrypted_file = 'files/carlos.sanson_AES_RW.enc'

output_private_key = 'files/carlos.sanson_privkeyRSA_RW.pem'
output_key = 'files/carlos.sanson_AES_key.'
output_file = 'files/carlos.sanson_AES_RW'
