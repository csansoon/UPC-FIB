...
Donat l'esquema adjunt, comproveu si es pot introduir alguna fila en alguna taula
(tenint en compte també les restriccions expressades com a vistes materialitzades).
Modifiqueu, si cal, la part de l'esquema que conté els "Create Table" eliminant-hi
restriccions (el mínim nombre possible, triant amb sentit comú) per tal que es pugui. 
