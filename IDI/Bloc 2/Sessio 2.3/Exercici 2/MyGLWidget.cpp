...
void MyGLWidget::mouseMoveEvent(QMouseEvent* event)
{
    ...
    //if      (event->x() > x_ant) girPsi -= 0.03;
    //else if (event->x() < x_ant) girPsi += 0.03;
    
    girPsi -= (event->x() - x_ant) * 0.03;
    
    //if      (event->y() > y_ant) girTheta -= 0.03;
    //else if (event->y() < y_ant) girTheta += 0.03;
    
    girTheta -= (event->y() - y_ant) * 0.03;
