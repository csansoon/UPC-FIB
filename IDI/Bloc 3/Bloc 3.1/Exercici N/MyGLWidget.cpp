...
void MyGLWidget::viewTransform ()
{
    ...
    View = glm::translate   (glm::mat4(1.0f), glm::vec3(0, 0, -distancia));
...
void MyGLWidget::canvia_perspectiva(bool yes) {
        counter = counter + 1;
        emit update_counter(counter);
        
        axonometric = yes;
        ini_camera();
        emit updateAxonometrica(axonometric);
}
...
void MyGLWidget::mouseMoveEvent(QMouseEvent *e)
{
  ...
  {
    girPsi -= (e->x() - xClick) * 0.03;
    girTheta -= (e->y() - yClick) * 0.03;
...
void MyGLWidget::setAxonometrica(const bool &yes) {
    canvia_perspectiva(yes);
    update();
}
